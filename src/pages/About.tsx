  ...
  return (
    <div className="min-h-screen bg-gradient-subtle py-20">
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 mb-20">
          <ModernCard variant="neumorphic" padding="lg">
            <div className="text-center">
              ...
              <h2 className="text-3xl font-bold mb-4 text-holographic">Our Mission</h2>
          ...
          <ModernCard variant="glass" padding="lg">
            <div className="text-center">
              ...
              <h2 className="text-3xl font-bold mb-4 text-gradient-accent">Our Values</h2>
              <p className="text-gray-600 dark:text-gray-400 leading-relaxed">
        ...
        {/* Team Section */}
        <div className="mb-20">
          <h2 className="text-4xl font-bold text-center mb-12 text-gradient-flow">Meet the Team</h2>
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            ...
            <ModernCard variant="default" padding="lg" hover className="text-center">
              ...
              <h3 className="text-xl font-bold mb-2 text-gradient-accent">Akshay Verma</h3>
            ...
            <ModernCard variant="neumorphic" padding="lg" hover className="text-center">
              ...
              <h3 className="text-xl font-bold mb-2 text-holographic">Tech Team</h3>
            ...
            <ModernCard variant="glass" padding="lg" hover className="text-center">
              ...
              <h3 className="text-xl font-bold mb-2 text-gradient-flow">Content Team</h3>
        ...
        <div className="mb-20">
          <h2 className="text-4xl font-bold text-center mb-12 text-holographic">Our Achievements</h2>
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            ...
            <div className="text-center">
              ...
              <div className="text-3xl font-bold text-gradient-flow mb-2">100K+</div>
            ...
            <div className="text-center">
              ...
              <div className="text-3xl font-bold text-gradient-accent mb-2">25+</div>
