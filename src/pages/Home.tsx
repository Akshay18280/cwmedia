...
export default function Home() {
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        // Fetch both featured posts and stats in parallel for better performance
  ...
  const statsData = useMemo(() => [
    ...
    {
      value: statsLoading ? null : statsService.formatNumber(stats?.monthlyViews || 0),
      label: "Monthly Readers",
      color: "green"
    },
    {
      value: statsLoading ? null : `${stats?.countriesReached || 1}+`,
      label: "Countries Reached",
      color: "purple"
    },
    {
      value: statsLoading ? null : statsService.formatUptime(stats?.systemUptime || 99.9),
      label: "System Uptime",
      color: "orange"
    }
  ], [stats, statsLoading]);
  ...
  return (
    <>
      <SEO
        ...
        description="Software Development Engineer at CSG International specializing in Golang, AWS, and scalable microservices. Technical blog with insights on building high-performance systems."
        keywords="Software Engineer, Golang, AWS, Microservices, DevOps, Cloud Architecture, Technical Blog, CSG International"
      />
      ...
      <div className="min-h-screen bg-gradient-to-br from-gray-50 via-white to-blue-50 dark:from-gray-900 dark:via-gray-800 dark:to-blue-900">
          ...
          <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-20 pb-16">
            <div className="text-center space-y-8">
              <div className="space-y-4">
                <h1 id="hero-heading" className="text-5xl md:text-7xl font-bold tracking-tight text-gray-900 dark:text-white">
                  Welcome to{' '}
              ...
              <span id="explore-description" className="sr-only">Navigate to blog articles</span>
              <span id="about-description" className="sr-only">Learn more about Akshay Verma</span>
            </div>
          </div>
        </section>

        {/* Stats Section */}
        <section className="py-16 bg-white/50 dark:bg-gray-800/50 backdrop-blur-sm" aria-labelledby="stats-heading">
        ...
        <section className="py-20" aria-labelledby="highlights-heading">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-16">
              <h2 id="highlights-heading" className="text-4xl font-bold text-gray-900 dark:text-white mb-4">
              ...
              {highlights.map((highlight, index) => (
                ...
                >
                  <div className={`w-16 h-16 rounded-xl bg-${highlight.color}-100 dark:bg-${highlight.color}-900 flex items-center justify-center mb-6 group-hover:scale-110 transition-transform duration-300`}>
                    <highlight.icon className={`w-8 h-8 text-${highlight.color}-600 dark:text-${highlight.color}-400`} aria-hidden="true" />
                  </div>
        ...
        <section className="py-20 bg-gradient-to-r from-blue-50 to-purple-50 dark:from-gray-800 dark:to-gray-900" aria-labelledby="featured-heading">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-16">
              ...
              <h2 id="featured-heading" className="text-4xl font-bold text-gray-900 dark:text-white mb-4">
                Latest Insights
              </h2>
              <p className="text-xl text-gray-600 dark:text-gray-300 max-w-3xl mx-auto">
              ...
              <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
                {featuredPosts.length > 0 ? (
                  featuredPosts.map((post, index) => (
                    ...
                    >
                      ...
                      <div className="p-6">
                        ...
                        <Link 
                          to={`/blog/${post.id}`} 
                          className="inline-flex items-center text-blue-600 dark:text-blue-400 font-medium hover:text-blue-700 dark:hover:text-blue-300 transition-colors focus:ring-2 focus:ring-blue-300 rounded"
                  ...
                  <div className="col-span-full text-center py-16">
                    ...
                    <Link 
                      to="/about" 
                      className="inline-flex items-center px-6 py-3 bg-blue-600 text-white font-medium rounded-lg hover:bg-blue-700 transition-colors focus:ring-4 focus:ring-blue-300"
                    >
                      Learn About Akshay
            ...
            {featuredPosts.length > 0 && (
              <div className="text-center mt-12">
                <Link 
                  to="/blog" 
                  className="group inline-flex items-center px-8 py-4 bg-white dark:bg-gray-800 text-gray-900 dark:text-white font-semibold rounded-xl shadow-lg hover:shadow-xl transform hover:scale-105 transition-all duration-200 focus:ring-4 focus:ring-gray-300 dark:focus:ring-gray-600"
                >
                  View All Articles
                  <ArrowRight className="w-5 h-5 ml-2 group-hover:translate-x-1 transition-transform" aria-hidden="true" />
                </Link>
        ...
        <section className="py-20 bg-gradient-to-r from-blue-600 to-purple-600 text-white" aria-labelledby="cta-heading">
          <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            <div className="space-y-8">
              ...
              <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
                <Link 
                  to="/blog" 
                  className="inline-flex items-center px-8 py-4 bg-white text-blue-600 font-semibold rounded-xl hover:bg-gray-100 transform hover:scale-105 transition-all duration-200 shadow-lg focus:ring-4 focus:ring-white/30"
                >
                ...
                <Link 
                  to="/about" 
                  className="inline-flex items-center px-8 py-4 border-2 border-white text-white font-semibold rounded-xl hover:bg-white hover:text-blue-600 transform hover:scale-105 transition-all duration-200 focus:ring-4 focus:ring-white/30"
                >
                  <Users className="w-5 h-5 mr-2" aria-hidden="true" />
                  Connect with Akshay
                </Link>
